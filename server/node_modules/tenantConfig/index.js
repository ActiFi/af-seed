...
var tenantConfig = {
  ...
  getCache:function(hostname){
    ...
    var cachedConfig = cache[hostname];
  ...
  setCache:function(hostname, config){
    if(!hostname) return;
        ...
        request(host+'/tenant/tenantContent-json.php', function (error, response, body) {
          if (!error && response.statusCode == 200) {
            try{
              ...
              reject('Failed to decode tenantContent');
            }
          } else {
            reject('Failed to retrieve tenantContent for this tenant');
          }
        })
      }
    })
